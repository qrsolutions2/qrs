      ...
      <div className="container mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <nav>
          <ul className="flex space-x-4">
            <li><a href="#how-it-works" onClick={smoothScroll} className="text-gray-600 hover:text-blue-600">How It Works</a></li>
            ...
            <li><a href="#contact" onClick={smoothScroll} className="text-gray-600 hover:text-blue-600">Contact</a></li>
          </ul>
        </nav>
      </div>
    </header>
